...
<html>
    ...
    <input  type="text" name="username" placeholder="Username" class="username">name </input>
      <input  type="number" name="password" placeholder="Password" class="password">password</input>
